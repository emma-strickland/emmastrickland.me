...
// API key
const LASTFM_API_KEY = "59aae518bb2169ec018f2706d6a0d135"
// API base URL
const LASTFM_BASE_URL = "http://ws.audioscrobbler.com/2.0/"

app.get("/recentlyPlayed", (_req, res) => {
    axios.get(`${LASTFM_BASE_URL}?method=user.getrecenttracks&user=stricklandemma&api_key=${LASTFM_API_KEY}&format=json`)
        .then(response => {
